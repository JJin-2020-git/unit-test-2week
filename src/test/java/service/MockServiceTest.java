...
public class MockServiceTest {
    ...
    @Test
    public void 어떤챔피언이름을입력해도_무조건_베인을_리턴한다() {
        Champion champion = mock(Champion.class);
    ...
    public void 챔피언이름이_야스오면_Exception_발생() {
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void 배열크기검증이_한번_실행되는지_verify() {
//        List<Champion> champions = new ArrayList<Champion>();
        ...
        int size = mockChampions.size(); //값이 나오지 않음
    ...
    @Test
    public void 이름가져오기가_두번이상_실행되는지_verify() {
        Champion champion = mock(Champion.class);
        champion.setName("직스");
        champion.setPosition("미드");
        champion.setHasSkinCount(7);

        String name1 = champion.getName();
    ...
    @Test
    public void 이름가져오기가_최소3번이하_실행되는지_verify() {
        Champion champion = mock(Champion.class);
        champion.setName("직스");
        champion.setPosition("미드");
        champion.setHasSkinCount(7);
    ...
    @Test
    public void 이름저장이_실행되지않았는지_verify() {
        Champion champion = mock(Champion.class);
        //champion.setName("직스");
        champion.setPosition("미드");
        champion.setHasSkinCount(7);
    ...
    @Test
    public void 이름가져오기가_200ms안에_1번_실행되었는지_verify() {
        Champion champion = mock(Champion.class);
        champion.setName("직스");
        champion.setPosition("미드");
        champion.setHasSkinCount(7);
...
//        verify(mockRepository, times(1)).findByName(anyString());
    ...
    @Test
    public void 리산드라이름으로검색_포지션탑이맞는지_verify() {
    ...
    @Test
    public void 챔피언개수가_맞는지_verify() {
        List<Champion> champions = new ArrayList<Champion>();

        champions.add(new Champion("직스", "미드", 7));
    ...
    public void testInvocationCountWhenGetChampionList() {
        ...
        when(mockService.findAllChampions()).thenReturn(champions);
        assertThat(mockService.findAllChampions().get(0).getName(), is("직스"));
        assertThat(mockService.findAllChampions().size(), is(3));
